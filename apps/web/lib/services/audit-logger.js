 ...
 */
export async function logSystemAction(action, entity, entityId, metadata) {
    return logAudit({
 ...
 */
export async function logAuthEvent(action, userId, role, ipAddress, metadata) {
    return logAudit({
        actorId: userId,
        actorRole: role,
        action,
 ...
 * Log an admin action
 */
export async function logAdminAction(action, adminId, entity, entityId, metadata, adminOnlyMemo, ipAddress) {
    return logAudit({
        actorId: adminId,
        actorRole: 'admin',
        action,
